...
<b>System Log</b>: Incoming message server activity - last 3 hours
<br>
<br>
...
$result = mysqli_query($con,"select * from logger where id like '%".$svr_type."serv%' and datetime > date_sub(utc_timestamp(), interval 180 minute) order by P_Id desc;");
