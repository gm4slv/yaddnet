...
<b>System Log</b>: Automatic deletions of data due to errors in reported frequency
<br>
<br>
...
$result = mysqli_query($con,"select * from logger where id like '%MODER%' and datetime > date_sub(utc_timestamp(), interval 24 hour) order by P_Id desc;");
