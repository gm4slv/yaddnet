...
<b>System Log</b>: Database maintenance activity
<br>
<br>
...
$result = mysqli_query($con,"select * from logger where id like '%PURGE%' and datetime > date_sub(utc_timestamp(), interval 24 hour) order by P_Id desc;");
