...
<b>System Log</b>: MMSI to Shipname conversion
<br>
<br>
...
$result = mysqli_query($con,"select * from logger where id like '%resolve%' and datetime > date_sub(utc_timestamp(), interval 120 minute) order by P_Id desc;");
