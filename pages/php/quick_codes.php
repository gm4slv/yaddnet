...
echo "<h3>Showing last 25 messages ".$fmt_disp." / ".$cat_disp." / ".$tc1_disp.".</h3>";
...
if (mysqli_connect_errno($con))
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
      ...
      $result = mysqli_query($con,"SELECT * FROM newlog where (FMT like '%".$fmt."%' and CAT like '%".$cat."%' and TC1 like '%".$tc1."%') order by datetime desc limit 25");
