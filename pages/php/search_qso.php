...
$ship_mmsi=$_GET['ship_mmsi'];


echo "<h3>Showing last 7 days' messages between $coast_mmsi and $ship_mmsi</h3>";

//$DATEQUERY="DATE_FORMAT(DATETIME, '%Y') like '%".$year."%' and DATE_FORMAT(DATETIME, '%m') like '%".$month."%' and DATE_FORMAT(DATETIME, '%d') like '%".$day."%'";

$DATEQUERY="datetime > date_sub(utc_timestamp(), interval 7 day)";
...
$header = "Datetime;rx_id;rx_freq;to_type;to_mmsi;to_name;to_ctry;cat;from_type;from_mmsi;from_name;from_ctry;tc1;tc2;freq;pos;eos;ecc\r\n\r\n";
fwrite($f, $header);
...
$result = mysqli_query($con, " select * from newlog where ".$DATEQUERY." and (  (raw_to_mmsi = ".$coast_mmsi." and raw_from_mmsi = ".$ship_mmsi.") or (raw_to_mmsi=".$ship_mmsi." and raw_from_mmsi=".$coast_mmsi.")) order by datetime desc");
