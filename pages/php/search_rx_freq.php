...
echo "<h3>Showing last 24 hours messages from<i> ".$rxid." </i> on ".$rx_freq."</h3>";



echo "Click on <a href='./search_rx.php?rxid=" .$rxid . "' style='color:#541B66' ><b>" .$rxid . "</b></a> to see messages on all frequencies<br><br>";
...
if (mysqli_connect_errno($con))
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
      ...
      $result = mysqli_query($con,"SELECT * FROM newlog where ".$DATEQUERY." and RX_ID = '".$rxid."' and RX_FREQ like '%".$rx_freq."%' order by datetime desc");
...
//  echo "<td align=center width='5%'><font face=monospace color=#424242 size='3pt'>" . $row['ECC'] . "<font></td>";
 ...
 echo "<td nowrap ><font face=monospace size='3pt'><a href='./search_rx.php?rxid=" . $row['RX_ID'] . "' style='color:#541B66' >" . $row['RX_ID'] . "</a></font></td>";
