...
<b>All</b> Messages, last 24 hours : All connected YaDD monitors : All bands<br>
<br>
<b>ECC = OK</b>
<br>
<br>
...
$result = mysqli_query($con,"SELECT * FROM newlog where datetime > date_sub(utc_timestamp(), interval 24 hour) and (( FROM_TYPE='COAST' and RAW_FROM_MMSI not like '00%') or (TO_TYPE='COAST' and RAW_TO_MMSI not like '00%')) and ecc not like '%err%'  order by datetime desc");
...
//  echo "<td width='6%'><font face=monospace color=blue size='3pt'>"  . $row['DATETIME'] . "</font> </td>";
  ...
  echo "<td  width='22%' nowrap><font face=monospace color=$colorto size='3pt'>" . $row['TO_TYPE'] . "</font><br>";
...
//echo " <font face=monospace color=$colorto size='3pt'>" . $row['RAW_TO_MMSI'] . " </font><br>";
  ...
  echo "<td  width='22%' nowrap><font face=monospace color=$colorfrom size='3pt'>" . $row['FROM_TYPE'] . "</font><br>";
