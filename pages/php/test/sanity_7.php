...
if (mysqli_connect_errno($con))
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
	...
	$result = mysqli_query($con, "select * from newlog where DATETIME>date_sub(now(), interval 7 day) and ( (RX_FREQ > 2189.5 and RX_FREQ < 30000.0 and FROM_TYPE = 'COAST' and ( FROM_MID = 244 or RAW_FROM_MMSI = '002191000' or FROM_MID = 247 or FROM_MID = 261 or FROM_MID = 232 or FROM_MID = 250 or FROM_MID = 211 or FROM_MID = 227 or FROM_MID = 205) and RAW_FROM_MMSI != '002320204'  and RAW_FROM_MMSI != '219015591' ) or (RX_FREQ = '2187.5' and FROM_TYPE = 'COAST' and (FROM_MID = 366 or FROM_MID = 503)) or ( RX_FREQ = '2177.0' and FROM_TYPE = 'COAST' and (FROM_MID != '257' and FROM_MID != '224' and FROM_MID != '251' and FROM_MID != '235' and FROM_MID != '237' and FROM_MID != '276' and FROM_MID != '205' and FROM_MID != '228' and FROM_MID != '258' and FROM_MID != '219' ) )) order by DATETIME desc");
