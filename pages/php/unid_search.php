...
<b>Last 30 days messages from selected UNID Coast Station<br>
<br>
<br>
<br>
...
$result = mysqli_query($con,"SELECT * FROM newlog where datetime > date_sub(utc_timestamp(), interval 30 day) and ( raw_from_mmsi = " . $from_mmsi . " or raw_to_mmsi = " . $from_mmsi . " )  order by datetime desc");
